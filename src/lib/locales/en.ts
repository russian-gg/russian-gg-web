...
export const en: Dictionary = {
  ...
  auth: {
    ...
    phone: {
      ...
      linkSubtitle:
        'To continue, confirm your phone number — this is a one-time step. You will then sign in by phone.',
      linkDoneTitle: 'Phone number linked',
      linkDoneBody: 'Now sign in with your phone number.',
      linkedBanner: 'Your phone number is confirmed. Now sign in by phone.',
      continue: 'Continue',
      errors: {
