...
export const uz = {
  ...
  lesson: {
    ...
    sectionNotes: {
      tests: "Kirish dialogi va yengil test",
      phonetics: "Talaffuz qoidasi",
      grammar: "So'zlarni bog'lash va gap tuzish qoidasi",
      phrases: "15 ta ibora — gif, tarjima va rang kodlari bilan",
      game: "Mavzu bo‘yicha yangi o‘yin",
      missions: "Dialogni o‘qish va AI bilan savol-javob",
      vocabulary: "20 ta karta — so‘z birikmalari va rasmlar",
      picture: "Ijodiy mashq: matn yoki dialog tuzish",
      complete: "Refleksiya va dars yakuni",
    },
