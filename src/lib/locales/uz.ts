...
export const uz = {
  ...
  auth: {
    ...
    phone: {
      ...
      linkSubtitle:
        "Davom etish uchun telefon raqamingizni tasdiqlang — bu bir martalik. So‘ng telefon orqali kirasiz.",
      linkDoneTitle: 'Telefon raqamingiz ulandi',
      linkDoneBody: 'Endi telefon raqamingiz orqali kiring.',
      linkedBanner: 'Telefon raqamingiz tasdiqlandi. Endi telefon orqali kiring.',
      continue: 'Davom etish',
      errors: {
